let lib = [];
const add = "add-book";
const close = "close-box";
const domId = document.getElementById.bind(document);

//class constuctor for new book
class Book {
...
function render() {
  ...
  lib.forEach((book, index) => {
    ...
    bookRemove.setAttribute(
      "src",
      "https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fendlessicons.com%2Fwp-content%2Fuploads%2F2012%2F12%2Ftrash-icon.png&f=1&nofb=1"
    );
